...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message:
          'Horário de término deve ser pelo menos uma hora após o início',
      },
    ),
})
...
export default function TimeIntervals() {
  ...
  } = useForm<TimeIntervalFormInput, unknown, TimeIntervalFormOutput>({
  ...
  async function handleSetTimeIntervals({ intervals }: TimeIntervalFormOutput) {
